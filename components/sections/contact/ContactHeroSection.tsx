        ...
        <div className="max-w-4xl py-24 sm:py-28">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#7DD3FC] via-[#05A2DA] to-white bg-clip-text text-transparent">
              {" "}
              de vos besoins ou de votre vision
            </span>
            .
          </motion.h1>
          ...
          >
            Vous avez une idée, un besoin en développement, en consulting, en
            marketing digital, en design, en conception ou en formation ?
            Échangeons ensemble pour construire quelque chose de solide.
          </motion.p>
        </div>
      </Container>
    </section>
