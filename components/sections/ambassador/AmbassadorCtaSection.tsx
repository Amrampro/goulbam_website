...
export default function AmbassadorCtaSection() {
  return (
      ...
      <Container>
        <AnimatedSection className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold sm:text-5xl">
            Vous connaissez un client potentiel ? Mettez-nous en relation.
          </h2>
          <p className="mt-6 text-base leading-8 text-slate-300">
            Une bonne recommandation peut créer de la valeur pour le client,
            pour l’entreprise et pour vous. Rejoignez le Programme Ambassadeur
            de GoulBAM Enterprises.
          </p>
