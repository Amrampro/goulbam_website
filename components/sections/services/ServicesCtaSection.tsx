      ...
      <Container>
        <AnimatedSection className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#7DD3FC]">
            Donnons forme à votre besoin
          </p>
          <h2 className="mt-4 text-3xl font-bold sm:text-5xl">
            Un projet en tête ? Nous pouvons vous aider à le concrétiser.
          </h2>
          <p className="mt-6 text-base leading-8 text-slate-300">
            Que vous soyez une entreprise, une organisation, une marque ou un
            porteur de projet, nous pouvons vous accompagner avec une approche
            sérieuse, moderne et adaptée.
          </p>
