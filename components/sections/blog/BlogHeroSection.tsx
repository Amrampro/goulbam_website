        ...
        <div className="max-w-4xl py-24 sm:py-28">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#7DD3FC] via-[#05A2DA] to-white bg-clip-text text-transparent">
              {" "}
              informer, inspirer et faire évoluer
            </span>{" "}
            votre vision.
          </motion.h1>
          ...
          >
            Retrouvez nos réflexions, analyses et contenus sur la technologie,
            la transformation digitale, le design, le consulting et l’évolution
            des projets.
          </motion.p>
        </div>
      </Container>
